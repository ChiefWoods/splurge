...
interface PythContextType {
  ...
  getUpdatePriceFeedTx: (id: string) => Promise<VersionedTransactionWithEphemeralSigners[]>;
}
...
export function PythProvider({ children }: { children: ReactNode }) {
  ...
  const [pythSolanaReceiver, setPythSolanaReceiver] = useState<PythSolanaReceiver | null>(null);
